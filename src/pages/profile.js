...
function Profile() {
  ...
  return (
    <Layout title={`${userInfo.name} profile | ECommerce-Website.`}>
      <div className="profile">
        <div className="container">
          <div className="profile__wrapper">
            ...
            <div className="profile__wrapper__image">
              <img
                src="https://res.cloudinary.com/medsy/image/upload/v1650317997/man-sitting_pe9w3x.jpg"
                alt="Profile"
              />
            </div>
          </div>
